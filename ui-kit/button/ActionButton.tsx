    ...
    return (
        <>
            ...
            <button
                ...
                className={`${buttonBase} ${hideId} ${shortId} text-black text-4 font-medium leading-5.5 hover:bg-grey-bg-hover active:bg-grey-bg-pressed bg-grey-bg-primary border border-grey-stroke px-5 py-3 flex items-center gap-2.5 ${props.className}`}
            >
                {props.icon && <BackIcon />}
                {renderText()}
            </button>
